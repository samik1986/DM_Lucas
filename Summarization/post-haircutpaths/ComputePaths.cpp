...
int main(int argc, char **argv) {
		...
		//string vfile_path = directory + "crossed-vert.txt", efile_path = directory + "haircut-edge.txt"; // input file paths. path to vertice, edge files.
		string vfile_path = directory + "haircut-no-dup-vert.txt", efile_path = directory + "haircut-no-dup-edge.txt"; // input file paths. path to vertice, edge files.
		string oefile_path = directory + "haircut-paths.txt";
